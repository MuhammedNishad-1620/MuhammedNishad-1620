# Hi, I'm Muhammed Nishad 👋

**AI Engineer** · Building intelligent systems with LLMs, RAG, and AI Agents  
📍 Bangalore, India · 🎓 MSc Big Data Analytics @ St. Joseph's University

---

## About Me

I build AI systems that are actually useful — not just prototypes. My work sits at the intersection of large language models, retrieval-augmented generation, and agentic workflows. I care about making AI reliable, observable, and production-ready.

Currently open to **AI Engineering roles** where I can work on LLM pipelines, AI agents, and intelligent infrastructure.

---

## What I Build

- **RAG Pipelines** — end-to-end retrieval systems with semantic search, reranking, and fallback strategies
- **AI Agents** — multi-step agentic workflows using LangGraph and LangChain
- **Computer Vision Systems** — surveillance and detection pipelines with YOLO and GCN models
- **Graph AI** — NLP interfaces over knowledge graphs (Neo4j + natural language Cypher)
...
**LLM & Agents**  
`LangChain` `LangGraph` `LlamaIndex` `Groq` `OpenAI API` `Hugging Face`

**ML & Deep Learning**  
`PyTorch` `YOLOv8` `Transformers` `BERT`

**Data & Infra**  
`FAISS` `Neo4j` `MongoDB` `RabbitMQ` `Docker` `AWS`

**Languages & Tools**  
`Python` `FastAPI` `Flask` `Streamlit` `SQL` `Git`
